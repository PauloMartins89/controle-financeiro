...
import LiderDDSGrupos from './pages/LiderDDSGrupos'
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // Prefere workspace real sobre placeholders (00000000-0000-0000-0000-xxxxxxxxxxxx)
      const isPlaceholderWs = (id) => id.startsWith('00000000-0000-0000-0000-')
      const workspaceId = allWorkspaceIds.find(id => !isPlaceholderWs(id)) || allWorkspaceIds[0] || null
            ...
            <div style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: 'var(--bg-primary)' }}>
              ...
              <main style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
                <Routes>
                  ...
                  <Route path="/lider/dds-grupos" element={<LiderDDSGrupos />} />
