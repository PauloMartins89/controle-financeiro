...
const navGroups = [
  {
    title: 'FinanceiroPro',
    items: [
      { to: '/',            icon: HomeIcon,                  label: 'Início',        moduleKey: 'financeiropro' },
      { to: '/despesas',    icon: CurrencyDollarIcon,        label: 'Meus Gastos',   moduleKey: 'financeiropro' },
      { to: '/quem-deve',   icon: ArrowsRightLeftIcon,       label: 'Acertos',       moduleKey: 'financeiropro' },
      { to: '/recorrentes', icon: ArrowPathIcon,             label: 'Fixos do Mês',  moduleKey: 'financeiropro' },
      { to: '/cartoes',     icon: CreditCardIcon,            label: 'Cartões',       moduleKey: 'financeiropro' },
      { to: '/grupos',      icon: UserGroupIcon,             label: 'Grupos',        moduleKey: 'financeiropro' },
      { to: '/pessoas',     icon: UsersIcon,                 label: 'Pessoas',       moduleKey: 'financeiropro' },
      { to: '/veiculos',    icon: TruckIcon,                 label: 'Veículos',      moduleKey: 'financeiropro' },
      { to: '/timeline',    icon: ChartBarIcon,              label: 'Histórico',     moduleKey: 'financeiropro' },
      { to: '/balanco',     icon: PresentationChartLineIcon, label: 'Balanço',       moduleKey: 'financeiropro' },
      { to: '/previsao',    icon: BanknotesIcon,             label: 'Caixa',         moduleKey: 'financeiropro' },      { to: '/proventos',   icon: ArrowTrendingUpIcon,        label: 'Proventos',          moduleKey: 'financeiropro' },
      { to: '/negocios',    icon: BuildingOffice2Icon,        label: 'Negócios',           moduleKey: 'financeiropro' },
    ],
  },
  {
    title: 'Prospectar',
    items: [
      { to: '/prospectar/dashboard',  icon: ChartBarIcon,              label: 'Dashboard',         moduleKey: 'prospectar' },
      { to: '/prospectar/buscar',     icon: MagnifyingGlassIcon,       label: 'Buscar Prospectos', moduleKey: 'prospectar' },
      { to: '/prospectar/contratos',  icon: DocumentTextIcon,          label: 'Contratos',         moduleKey: 'prospectar' },
      { to: '/prospectar/relatorios', icon: PresentationChartLineIcon, label: 'Relatórios',        moduleKey: 'prospectar' },
    ],
  },
  {
    title: 'Gerencial',
  ...
  },
  {
    title: 'Automação',
    items: [
      { to: '/flow-center', icon: BoltIcon,    label: 'Flow Center', moduleKey: 'automacao' },
      { to: '/flow-lab',        icon: BeakerIcon,      label: 'Flow Lab',    moduleKey: 'automacao' },
      { to: '/simulacao-fluxo', icon: DevicePhoneMobileIcon, label: 'Simulação',   moduleKey: 'automacao' },
    ],
  },
  {
    title: 'Refeições',
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/lider/dds',                     icon: ShieldCheckIcon,           label: 'Sessões DDS',         moduleKey: 'smartlider' },
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/maquinas/dashboard',      icon: ChartBarIcon,             label: 'Dashboard & Relatórios',  moduleKey: 'maquinas' },
      { to: '/maquinas/pendencias',     icon: ExclamationTriangleIcon,  label: 'Pendências',              moduleKey: 'maquinas' },
      { to: '/cadastros?aba=maquinas',  icon: WrenchScrewdriverIcon,    label: 'Cadastros',               moduleKey: 'maquinas' },
    ],
  },
  {
    title: 'Agendamentos',
