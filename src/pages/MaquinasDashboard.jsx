...
function KPICard({ label, value, sub, color, bg, icon: Icon }) {
  return (
    <div style={{
      background: 'var(--bg-card)', boxShadow: 'var(--shadow-card)', borderRadius: 14, padding: '14px 16px',
...
export default function MaquinasDashboard() {
  ...
  const cardStyle = { background: 'var(--bg-card)', boxShadow: 'var(--shadow-card)', borderRadius: 14, border: '1px solid var(--border)', padding: '16px 18px' }
