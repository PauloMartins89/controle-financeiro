        ...
        {resultado?.resumo && (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: 16, marginBottom: 24 }}>
            {[
              ...
              return (
                <div key={card.label} style={{ background: `linear-gradient(135deg, ${card.color}14 0%, var(--bg-card) 55%)`, boxShadow: 'var(--shadow-card)', borderRadius: 14, padding: '18px 20px', border: `1px solid ${card.color}28`, borderTop: `3px solid ${card.color}`, display: 'flex', alignItems: 'center', gap: 14 }}>
